...
// Também podemos fazer com que dois cases usem o mesmo bloco como no
...
const imprimirResultado = function (nota) {
    switch (Math.floor(nota)) {
        case 10:
        case 9: {
            // você pode usar bloco de código com chaves, mas não é algo comum
        ...
        // break;
        default: // se você não usar o default no final você deve ter o cuidado de usar o break
